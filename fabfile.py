...
config = {
    ...
    "repo_url": "git@gitlab.com:ingenix/hashtag-parsing/admin-panel.git",
    "app_path": "~/admin-panel",
    "app_branch": "master",

    "docker_image": "registry.gitlab.com/ingenix/hashtag-parsing/admin-panel",
    "image_type": "prod",
    "image_version": "latest",

    "deploy_server": "52.35.243.163",
    "compose_path": "/opt/servers",
    "compose_block_name": "admin-dashboard"
}
